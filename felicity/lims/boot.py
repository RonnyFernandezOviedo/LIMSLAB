...
#from starlette.middleware.cors import CORSMiddleware remove by ronny
from fastapi.middleware.cors import CORSMiddleware # add by ronny
...
from apps.events.events import observe_events
...
def register_cors(app: FastAPI):
    app.add_middleware(
        CORSMiddleware,
        allow_origins=  ["*"], #["http://127.0.0.1:8000","http://127.0.0.1:5173", "http://192.168.100.9:8000","http://localhost:5173",],   #settings.CORS_ORIGINS, valor orig  ["*"] add by ronny
