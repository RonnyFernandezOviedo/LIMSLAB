      ...
      <div class="col-span-12 sm:col-start-3 sm:col-end-13 px-3 sm:px-0">
        ...
        <div class="grid grid-cols-3 gap-x-8 mt-2">
          ...
          <div class="col-span-1">
            <h1 class="uppercase text-sm font-semibold">origen muestra</h1>
            <hr class="my-1">
            <!-- Client Details -->
          ...
          <div class="col-span-1">
            ...
            <!-- Client Details -->
            <div class="flex justify-between items-center mt-2">
              <span class="text-gray-800 text-sm font-semibold">Cliente</span>
              <span class="text-gray-600 text-sm md:text-md">{{
                patient?.client?.name
              }}</span>
            </div>
          ...
          <div class="col-span-1 mr-2">
            ...
            <!--xxx<div class="flex justify-between items-center mt-2">
