...
let currentTab = ref<string>("Muestras");
const tabs: string[] = ["Muestras","logs"]; //"casos", "logs"
...
<template>
  <PageHeading title="resumen solicitudes" />
  <div class="">
    <div class="flex justify-between">
      <div class="flex items-center content-between">
        ...
        <input
          ...
          type="text" placeholder="Buscar ..." aria-label="Search" @keyup="searchPatients($event)"
    ...
    <div class="grid grid-cols-12 gap-4 mt-2">
      ...
      <section v-if="isPatientSelected" v-motion :initial="{ opacity: 0, y: -100 }"
        ...
        <tab-samples v-if="currentTab === 'Muestras'" target="patient-samples" :targetUid="patientForm.uid" />
