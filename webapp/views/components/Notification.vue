...
<template>
  <div ref="checdiv"
    class="w-full h-screen bg-gray-800 bg-opacity-90 top-0 overflow-y-auto hidden overflow-x-hidden fixed sticky-0 z-10">
        ...
        <div v-for="stream of streamStore.streams" :key="stream?.uid"
          ...
          <div class="pl-2">
            <p tabindex="0" class="focus:outline-none text-sm leading-none">
              ...
              <span class="text-indigo-700 font-semibold text-sm">{{ stream?.actionObject.sampleId ??
