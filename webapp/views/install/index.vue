  ...
  <div class="flex justify-center items-center h-screen bg-sky-800 px-6">
    <div class="p-6 max-w-sm w-full bg-white shadow-md rounded-sm">
      <div class="flex justify-center items-center">
        ...
        <span class="text-gray-700 font-semibold text-2xl">Instalar App</span>
      </div>

      <form class="mt-4" @submit.prevent="initInstall">
        <label class="block">
          <span class="text-gray-700 text-sm">Nombre de Laboratorio</span>
          <input
            type="text"
        ...
        <div class="mt-6">
          ...
          <div v-else class="text-center">
            <LoadingMessage message="Instalando App ..." />
          </div>
        </div>
      </form>
    </div>
