<script setup lang="ts">
  ...
  function FormManager(create: boolean, obj = {} as IInstrument): void {
    ...
    formTitle.value = (create ? 'CREAR' : 'EDITAR') + ' ' + "INSTRUMENTO";
    if (create) {
    ...
    <div class="overflow-x-auto mt-4">
      ...
      <table class="min-w-full">
          ...
          <tr>
              ...
              <th class="px-1 py-1 border-b-2 border-gray-300 text-left text-sm leading-4 text-gray-800 tracking-wider">Tipo</th>
              <th class="px-1 py-1 border-b-2 border-gray-300 text-left text-sm leading-4 text-gray-800 tracking-wider">Fabricante</th>
              <th class="px-1 py-1 border-b-2 border-gray-300 text-left text-sm leading-4 text-gray-800 tracking-wider">Proveedor</th>
          ...
          <tr v-for="inst in instruments" :key="inst?.uid">
              ...
              <td class="px-1 py-1 whitespace-no-wrap text-right border-b border-gray-500 text-sm leading-5">
                  <button @click="FormManager(false, inst)" class="px-2 py-1 mr-2 border-sky-800 border text-sky-800 rounded-sm transition duration-300 hover:bg-sky-800 hover:text-white focus:outline-none">Editar</button>
              </td>
          </tr>
          </tbody>
      </table>
      ...
      <form action="post" class="p-1">
        <div class="grid grid-cols-3 gap-x-4 mb-4">
          <label class="block col-span-2 mb-2">
            <span class="text-gray-700">Nombre Instrumento</span>
            <input
          ...
          <label class="block col-span-1 mb-2" >
            <span class="text-gray-700 w-4/12">Tipo Instrumento</span>
            <div class="w-full">
          ...
          <label class="block col-span-1 mb-2" >
            <span class="text-gray-700 w-4/12">Fabricante</span>
            <div class="w-full">
          ...
          <label class="block col-span-1 mb-2" >
            <span class="text-gray-700 w-4/12">Proveedor</span>
            <div class="w-full">
