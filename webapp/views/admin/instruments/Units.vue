<script setup lang="ts">
  ...
  function FormManager(create: boolean, obj = {} as IUnit): void {
    ...
    formTitle.value = (create ? 'CREAR' : 'EDITAR') + ' ' + "UNIDAD";
    if (create) {
      ...
      <form action="post" class="p-1">
        <div class="grid grid-cols-2 gap-x-4 mb-4">
          <label class="block col-span-2 mb-2">
            <span class="text-gray-700">Nombre Unidad</span>
            <input
          ...
          <label class="block col-span-2 my-2">
            ...
            />
            <span class="text-gray-700 ml-4">Es unidad SI</span>
          </label>
        </div>
        <hr />
        <button
