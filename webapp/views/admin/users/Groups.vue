...
const accordion = defineAsyncComponent(
  ...
  function FormManager(create: boolean, obj = {} as IGroup): void {
    ...
    formTitle.value = (create ? 'CREAR' : 'EDITAR') + ' ' + "PERFIL";
    if (create) {
              ...
              <div class="flex justify-between">
                <section>
                  ...
                  <div div class="flex justify-start mt-2">
                    <h3 class="mr-2 text-gray-600 font-semibold">Secciones: </h3>
      ...
      <form action="post" class="p-1">
        <div class="grid grid-cols-2 gap-x-4 mb-4">
          <label class="block col-span-2 mb-2">
            <span class="text-gray-700">Nombre Grupo</span>
            <input
          ...
          <label class="block col-span-2 mb-2">
            <span class="text-gray-700">Secciones</span>
            <select 
              name="controlLevels" 
              id="controlLevels" 
