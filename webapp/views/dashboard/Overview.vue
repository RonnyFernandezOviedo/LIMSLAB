...
<template>
  ...
  <div v-if="dashboard.fetchingOverViewStats" class="text-start my-4 w-100">
    <LoadingMessage message="Obteniendo estadísticas generales actualizadas ..." />
  </div>
  <section>
  
    <h1 class="text-xl text-gray-700 font-semibold">Estado de Analisis</h1>
    <hr class="my-2" />
    ...
    <p v-if="!dashboard.overViewStats?.analyses?.length" class="my-4">No encontré ningún indicador de análisis para mostrar</p>

    <h1 class="mt-4 text-xl text-gray-700 font-semibold">Estado de la Muestra</h1>
    <hr class="my-2" />
    <div class="flex justify-start">
      <div
    ...
    <p v-if="!dashboard.overViewStats?.samples?.length" class="my-4">No encontré ningún indicador de muestra para mostrar</p>

    <h1 class="mt-4 text-xl text-gray-700 font-semibold">Estado hoja de trabajos</h1>
    <hr class="my-2" />
    <div class="flex justify-start">
      <div
    ...
    <p v-if="!dashboard.overViewStats?.worksheets?.length" class="my-4">No encontré ningún indicador de hoja de trabajo para mostrar</p>
    ...
    <div class="flex justify-start">
      ...
      <p v-if="!dashboard.overViewStats?.extras?.length" class="my-4">No encontré ningún indicador extra para mostrar</p>
    </div>
  </section>
</template>
