...
<template>
  ...
  <h1 class="text-xl text-gray-700 font-semibold">
    Rendimiento del proceso para muestras en días promedio
  </h1>
  <hr class="mt-1 mb-2" />

  <div class="bg-slate-200 p-2 mb-4">
    <div v-if="dashboard.fetchingSampePeformanceStats" class="text-start my-4 w-100">
      <LoadingMessage message="obteniendo estadísticas de rendimiento de muestra actualizadas..." />
    </div>
    <div class="flex flex-wrap justify-start">
      <div class="mr-4 items-center content-center">
        <div class="bg-white shadow rounded-sm px-6 pt-3 pb-5 border border-white mr-8 text-center">
          <div class="font-semibold text-gray-400 text-l">recibido a publicado</div>
          <div class="mr-4 font-bold text-gray-600 text-xl">
            {{ prRTP?.counts?.processAverage ?? 0 }} dias
          </div>
        </div>
        <div id="rtp-graph">
      ...
      <div class="mr-4 items-center content-center">
        <div class="bg-white shadow rounded-sm px-6 pt-3 pb-5 border border-white mr-8 text-center">
          <div class="font-semibold text-gray-400 text-l">recibido a enviado</div>
          <div class="mr-4 font-bold text-gray-600 text-xl">
            {{ prRTS?.counts?.processAverage ?? 0 }} dias
          </div>
        </div>
        <div id="rts-graph">
      ...
      <div class="mr-4 items-center content-center">
        <div class="bg-white shadow rounded-sm px-6 pt-3 pb-5 border border-white mr-8 text-center">
          <div class="font-semibold text-gray-400 text-l">enviado a verificado</div>
          <div class="mr-4 font-bold text-gray-600 text-xl">
            {{ prSTV?.counts?.processAverage ?? 0 }} dias
          </div>
        </div>
        <div id="stv-graph">
      ...
      <div class="mr-4 items-center content-center">
        <div class="bg-white shadow rounded-sm px-6 pt-3 pb-5 border border-white mr-8 text-center">
          <div class="font-semibold text-gray-400 text-l">verificado a publicado</div>
          <div class="mr-4 font-bold text-gray-600 text-xl">
            {{ prVTP?.counts?.processAverage ?? 0 }} dias
          </div>
        </div>
        <div id="vtp-graph">
  ...
  <h1 class="mt-1 text-xl text-gray-700 font-semibold">
    <span>Rendimiento de procesos por análisis</span>
  ...
  <div class=" bg-slate-200 p-2">
    <div v-if="dashboard.fetchingAnalysisPeformanceStats" class="text-start my-4 w-100">
      <LoadingMessage message="obteniendo estadísticas de rendimiento del análisis..." />
    </div>
    <div id="ap-graphs">
