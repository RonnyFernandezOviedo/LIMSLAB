...
<template>
  <div v-if="dashboard.fetchingLaggards" class="text-start my-4 w-100">
    <LoadingMessage message="obteniendo estadísticas rezagadas..." />
  </div>
  <section>
    <h1 class="text-xl text-gray-700 font-semibold">Retrasada e incompleta</h1>
    <hr class="my-2" />
    <div class="flex justify-start items-center">
      ...
      >
        ...
        <div class="font-semibold text-gray-400 text-l">Ya retrasada</div>
      </div>
    ...
    <h1 class="mt-4 text-xl text-gray-700 font-semibold">Autorizada ya retrasada</h1>
    <hr class="my-2" />
    <div class="flex justify-start items-center">
      <div
        class="content-middle bg-white shadow rounded-sm px-6 pt-3 pb-5 border border-white mr-8 text-center"
      >
        ...
        <div class="font-semibold text-gray-400 text-l">Liberada como retrasada</div>
      </div>
