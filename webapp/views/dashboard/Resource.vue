...
<template>
  ...
  <div v-if="dashboard.fetchingResourceStats" class="text-start my-4 w-100">
    <LoadingMessage message="obteniendo estadísticas de recursos..." />
  </div>
  <section>
    <h1 class="text-xl text-gray-700 font-semibold">Matriz Intrumento / Load</h1>
    <hr class="my-2" />
    <div v-if="dashboard.resourceStats?.instruments?.length === 0">SIN DATOS</div>
    ...
    <h1 class="mt-8 text-xl text-gray-700 font-semibold">Matriz Usuario / Load</h1>
    <hr class="my-2" />
      ...
      <form action="post" class="p-1">
        <div class="grid grid-cols-2 gap-x-4 mb-4">
          <label class="block col-span-2 mb-2">
            <span class="text-gray-700">Fecha de</span>
            <input
              type="datetime-local"
          ...
          <label class="block col-span-2 mb-2">
            <span class="text-gray-700">Fecha hasta</span>
            <input
              type="datetime-local"
              class="form-input mt-1 block w-full"
